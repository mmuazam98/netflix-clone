...
!(function (e, t) {
  ...
  (E.fn = E.prototype = {
    ...
    E.extend({
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (d(Object(e)) ? E.merge(n, "string" == typeof e ? [e] : e) : u.call(n, e)),
          n
        );
      },
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            (r = Y.get(e, t)),
            n &&
              (!r || Array.isArray(n) ? (r = Y.access(e, t, E.makeArray(n))) : r.push(n)),
            r || []
          );
      },
  ...
  (he.tbody = he.tfoot = he.colgroup = he.caption = he.thead),
    (he.th = he.td),
    m.option ||
      (he.optgroup = he.option = [1, "<select multiple='multiple'>", "</select>"]);
  var ye = /<|&#?\w+;/;
    ...
    special: {
      ...
      click: {
        ...
        _default: function (e) {
          var t = e.target;
          return (
            (fe.test(t.type) && t.click && S(t, "input") && Y.get(t, "click")) ||
            S(t, "a")
          );
        },
      },
